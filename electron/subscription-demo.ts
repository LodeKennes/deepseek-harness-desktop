  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .action {
      ...
      border-radius: 8px; text-align: center; text-decoration: none; background: var(--panel);
    ...
    .ready-icon { display: grid; flex: 0 0 auto; place-items: center; width: 25px; height: 25px; border-radius: 50%; color: white; background: var(--success); font-size: 13px; font-weight: 800; }
    ...
    .primary { padding: 9px 14px; border-radius: 9px; color: #fff; background: #2563eb; font-size: 12px; font-weight: 720; text-decoration: none; box-shadow: 0 1px 2px rgba(0,0,0,.15); }
