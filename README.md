...
<p align="center">
  ...
  <a href="https://github.com/deepseek-ai/deepseek-harness"><img src="https://img.shields.io/badge/harness-0.1.1--rc.1-4176e6" alt="Pinned Harness version"></a>
...
| Field | Current |
| --- | --- |
| Desktop base | `0.1.1-rc.1` · `ai.deepseek.harness.desktop` |
| Harness | `0.1.1-rc.1` at `528c682e061696f5a160f363f236ecbf53cbd006` |
| Node (bundled) | `24.19.0` |
| pnpm | `11.21.0` |
| Electron | `43.4.0` |
| CLIProxyAPI | `7.2.132` |

A push to `master` publishes `desktop-v0.1.1-rc.1-build-N`. The desktop base version matches Harness, while `build-N` is a globally increasing desktop build counter. Bumping the Harness version and SHA is a deliberate commit here. There is no git submodule and no vendored Harness tree.
